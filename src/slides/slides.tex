...
\begin{frame}{Contributions}
  \begin{itemize}
    \item<1-> A tracking library for the web called \textit{tracking.js}
    \item<1-> Optimizations for existing techniques in order to run in real-time on the web
    \item<1-> Pioneered a library that brings state-of-the-art techniques for computer vision to the web
    \item<1-> Academic material about web browser concepts
  \end{itemize}
\end{frame}
...
\begin{frame}{Popularity}
  \begin{itemize}
    \item<1-> 445 tweets mentioning \textit{tracking.js}
    \item<1-> 31,258 website page views
    \item<1-> Project hosted on Mozilla Developer Network
    \item<1-> Talk presented on DevFest Brazil - Brazil, 2012
    \item<1-> Talk presented on W3C Conference - Brazil, 2012
    \item<1-> Talk presented on HTML5 Dev Conf - USA, 2013
    \item<1-> Talk accepted on JS.everywhere - USA, 2013
  \end{itemize}
\end{frame}
