...
\begin{frame}{Examples}
  \begin{figure}[!htb]
    ...
    \caption{Library implementation of color tracking for different objects: On the left a red pencil marker; on the center a Rubik's magic cube from the red face; and on the right a red Ball of Whacks.}
  \end{figure}
\end{frame}
...
\begin{frame}{Examples}
  \begin{figure}[!htb]
    ...
    \caption{Library implementation of markerless tracking technique.}
  \end{figure}
\end{frame}
...
\begin{frame}{Bonus - Repercussion}
  \begin{figure}[!htb]
    \centering
...
\begin{frame}{Bonus - Repercussion}
  \begin{itemize}
    ...
    \item Project hosted on Developer Mozilla
