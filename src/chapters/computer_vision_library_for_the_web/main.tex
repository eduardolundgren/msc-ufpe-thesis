...
\begin{center}
    ...
    \begin{tikzpicture}
        \begin{umlpackage}{Base classes}
            ...
            \umlclass[y=-290pt]{Canvas}{
                context : Object
            }{
                forEach(data, callback) : void\\
                getImageData(x, y, width, height) : Array \\
                setImageData(data, x, y) : void\\
                transform() : void\\
            }

            \umlclass[y=-440pt]{Video}{}{
                play() : void\\
                pause() : void\\
                track(tracker) : void \\
                getVideoCanvasImageData(x, y, width, height) : Array \\
            }

            \umlclass[y=-430pt,x=200pt]{VideoCamera}{}{
                capture() : void \\
            }
...
\begin{center}
    ...
    \begin{tikzpicture}
        \begin{umlpackage}{Augmented reality classes}
            ...
            \umlclass{FAST}{}{
                findCorners(frame, threshold) : Array\\
            }

            \umlclass[y=-90pt]{BRIEF}{}{
                getDescriptors(frame, corners) : Array\\
                match(corners1, descriptors1, corners2, descriptors2) : Array\\
            }

            \umlclass[y=-240pt]{Math}{}{
                createIdentityMatrix(size) : Matrix\\
                distance() : Number\\
                getDeterminant(Matrix) : Number\\
                getInverse(Matrix) : Matrix\\
                hammingDistance(descriptors1, descriptors2) : Number\\
                hammingWeight(number) : Number\\
                ...
            }

            \umlclass[x=240pt]{RANSAC}{}{
                find(matches) : void\\
                score() : Number\\
            }

            \umlclass[y=-90pt,x=240pt]{Homography}{}{
                score(H, matches) : Number\\
            }

            \umlclass[y=-160pt,x=240pt]{Pose}{}{}
