...
Color tracking technique implementation of \textit{tracking.js} shows good results for partial occlusions. Figure \ref{figure:color_occlusion} demonstrates occlusions variations that still allows the colored object to be detected.
...
\subsection{Benefits of a JavaScript tracking solution} % (fold)
\label{sec:evaluation:results:js_tracking_solution}

\subsubsection{Discussion} % (fold)
\label{subsub:evaluation:results:js_tracking_solution:discussion}
...
% subsection js_tracking_solution (end)
