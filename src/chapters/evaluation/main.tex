...
Being able to use colored objects to control your browser trough the camera is very appealing. Any colored object could serve as a tool for the user interaction trough a simple and intuitive JavaScript API (Listing \ref{lst:color}). Figure \ref{figure:color_object} illustrates different colored objects being tracked.
