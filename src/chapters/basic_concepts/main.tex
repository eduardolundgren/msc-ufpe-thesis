...
The 3D tracking literature is particularly massive both because there are almost as many approaches as target applications and because many different approaches to solving the same problem are possible. Here we focus on a web based online model-based 2D tracking using a single camera.
