...
Nevertheless, reading and writing raw binary data using typed arrays solves part of the problem of manipulating video and images. The other missing feature was resolved by the fact of HTML5 brings a new element called \textit{canvas}, which provides access to the pixel matrix of those medias in order to be manipulated from Augmented Reality (AR) algorithms.
